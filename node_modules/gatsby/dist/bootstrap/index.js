...
const preferDefault = require(`./prefer-default`); // Add `util.promisify` polyfill for old node versions
...
module.exports = async args => {
  ...
  activity.start();
  let config = await preferDefault(getConfigFile(program.directory, `gatsby-config`)); // The root config cannot be exported as a function, only theme configs
